package sg.edu.rp.c346.id21021436.demomyprofile;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPause(){
        ...
        //Step 1e: Call commit() to save the changs into SharedPreferences
        prefEdit.commit();
    }
    ...
    protected void onResume(){
        ...
        String strName = prefs.getString("name", "Sidhant");
